import { CreateTournament } from './create_tou.js' ;
import { ListTournament } from './list_tou.js' ;
...
export class Tournament extends HTMLElement
{
	constructor()
	{
		...
		this.innerHTML = `
				...
				<div id="create_join_">
					<div id="create">
						<img src="../images/create_img.svg" width="100%" height="100%">
					</div>
					<div id="line_">
						<div id="star">
					...
					<div id="join">
						<img src="../images/join_img.svg" width="100%" height="100%">
					</div>
				</div>
		`
		this.querySelector('#create').addEventListener('click', to_create);
		this.querySelector('#join').addEventListener('click', to_join);
